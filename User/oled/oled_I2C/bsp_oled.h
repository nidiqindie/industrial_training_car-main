...
#define OLED_SCL_Clr() GPIO_ResetBits(GPIOC,GPIO_Pin_12)//SCL
#define OLED_SCL_Set() GPIO_SetBits(GPIOC,GPIO_Pin_12)

#define OLED_SDA_Clr() GPIO_ResetBits(GPIOC,GPIO_Pin_11)//DIN
#define OLED_SDA_Set() GPIO_SetBits(GPIOC,GPIO_Pin_11)
